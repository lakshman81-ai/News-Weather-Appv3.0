...
export const quickFactsService = {
    ...
    fetchDailyFacts: async () => {
        ...
        try {
            ...
            return [
                { year: '1969', text: 'The internet (ARPANET) sent its first message.' },
                { year: '1990', text: 'The first web page was published by Tim Berners-Lee.' },
                { year: '2004', text: 'Facebook was launched by Mark Zuckerberg.' }
            ];
        }
    }
};
